...
const loadeComp = {
    ...
    config: {
        ...
        model: [{
            url: publicPath + 'yueyuan/yueyuan01.FBX',
            id: 'index_1',
...
const cameraComp = {
    ...
    config: {
        data: [{
            ...
            {
                camera: { x: -92.81, y: 99.07, z: 138.5 },
                target: { x: 43.59, y: 0, z: 10.87 }
            }]
        },
        {
            id: 'path_2',
            ...
            data: [{
                camera: { x: 59.76, y: 29, z: 127.8 },
                target: { x: 51.42, y: 0, z: 29.11 }
            },
            {
                camera: { x: 195.15, y: 95.46, z: 213.33 },
                target: { x: 47.05, y: -0, z: 4.91 }
            },
            { type: 'spin', angle: [0, -Math.PI * 1.45], speed: 25 },
            ]
        },
        ]
    },
        ...
        data: [
            {
                ...
                meshData: {
                    type: 'data',
                    data: yueyuanTree.tree_a
                }, //实例化的数据，可以为模型数据或者是JSON数据
                model: {
                    url: publicPath + 'yueyuan/tree_a.FBX', // 模型地址
            ...
            },
            {
                ...
                meshData: {
                    type: 'data',
                    data: yueyuanTree.tree_b
                }, //实例化的数据，可以为模型数据或者是JSON数据
                model: {
                    url: publicPath + 'yueyuan/tree_b.FBX', // 模型地址
            ...
            },
            {
                ...
                meshData: {
                    type: 'data',
                    data: yueyuanTree.tree_c
                }, //实例化的数据，可以为模型数据或者是JSON数据
                model: {
                    url: publicPath + 'yueyuan/tree_c.FBX', // 模型地址
            ...
            },
            {
                ...
                meshData: {
                    type: 'data',
                    data: yueyuanTree.tree_d
                }, //实例化的数据，可以为模型数据或者是JSON数据
                model: {
                    url: publicPath + 'yueyuan/tree_d.FBX', // 模型地址
                    randomRotate: {
                        z: Math.PI * 2
                    },
                }
            },
            {
                ...
                meshData: {
                    type: 'data',
                    data: yueyuanTree.tree_e
                }, //实例化的数据，可以为模型数据或者是JSON数据
                model: {
                    url: publicPath + 'yueyuan/tree_e.FBX', // 模型地址
            ...
            },
            {
                ...
                meshData: {
                    type: 'data',
                    data: yueyuanTree.tree_f
                }, //实例化的数据，可以为模型数据或者是JSON数据
                model: {
                    url: publicPath + 'yueyuan/tree_f.FBX', // 模型地址
            ...
            },
            {
                ...
                meshData: {
                    type: 'data',
                    data: yueyuanTree.tree_g
                }, //实例化的数据，可以为模型数据或者是JSON数据
                model: {
                    url: publicPath + 'yueyuan/tree_g.FBX', // 模型地址
            ...
            },
            {
                ...
                meshData: {
                    type: 'data',
                    data: yueyuanTree.tree_h
                }, //实例化的数据，可以为模型数据或者是JSON数据
                model: {
                    url: publicPath + 'yueyuan/tree_h.FBX', // 模型地址
            ...
            },
            {
                ...
                meshData: {
                    type: 'data',
                    data: yueyuanTree.tree_i
                }, //实例化的数据，可以为模型数据或者是JSON数据
                model: {
                    url: publicPath + 'yueyuan/tree_i.FBX', // 模型地址
                    randomRotate: {
                        z: Math.PI * 2
                    },
                    colors: [
            ...
            },
            {
                ...
                meshData: {
                    type: 'data',
                    data: yueyuanTree.tree_j
                }, //实例化的数据，可以为模型数据或者是JSON数据
                model: {
                    url: publicPath + 'yueyuan/tree_j.FBX', // 模型地址
            ...
            },
            {
                ...
                meshData: {
                    type: 'data',
                    data: yueyuanTree.tree_l
                }, //实例化的数据，可以为模型数据或者是JSON数据
                model: {
                    url: publicPath + 'yueyuan/tree_l.FBX', // 模型地址 
                }
            }
        ],
        material: {
...
instance.init({
    ...
    {
        id: 'DX_001',
        url: publicPath + 'yueyuan/DX_001.jpg'
    },
    {
        id: 'DX_002',
        url: publicPath + 'yueyuan/DX_002.jpg'
    },
    {
        id: 'JZ_01',
        url: publicPath + 'yueyuan/JZ_01.jpg'
    },
    {
        id: 'JZ_02',
        url: publicPath + 'yueyuan/JZ_02.jpg'
    },
    {
        id: 'JZ_03',
        url: publicPath + 'yueyuan/JZ_03.jpg'
    },
    {
        id: 'JZ_04',
        url: publicPath + 'yueyuan/JZ_04.jpg'
    },
    {
        id: 'JZ_05',
        url: publicPath + 'yueyuan/JZ_05.jpg'
    },
    ]
});
