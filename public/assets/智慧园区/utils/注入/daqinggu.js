...
const treeDatas = [
    { name: 'tree_a', url: 'tree_a.FBX' },
    { name: 'tree_b', url: 'tree_b.FBX' },
    { name: 'tree_c', url: 'tree_c.FBX' },
    { name: 'tree_d', url: 'tree_d.FBX' },
    { name: 'tree_e', url: 'tree_e.FBX' },
    { name: 'tree_f', url: 'tree_f.FBX' },
    { name: 'tree_g', url: 'tree_g.FBX' },
    { name: 'tree_h', url: 'tree_h.FBX' },
    { name: 'tree_i', url: 'tree_i.FBX' },
    { name: 'tree_j', url: 'tree_j.FBX' },
    { name: 'tree_k', url: 'tree_k.FBX' },
    { name: 'tree_l', url: 'tree_l.FBX' },
    { name: 'tree_m', url: 'tree_m.FBX' },
    { name: 'tree_n', url: 'tree_n.FBX' },
]
const TREE_DATA = treeDatas.map((d) => {
    return {
        renderOrder: 1,
        meshData: {
            type: 'data',
            data: daqingguTree[d.name]
        }, //实例化的数据，可以为模型数据或者是JSON数据
        model: {
            url: publicPath + 'daqinggu/' + d.url // 模型地址
        }
    }
})
const instanceCom1 = {
...
instance.init({
    ...
    {
        id: 'cha',
        url: publicPath + 'daqinggu/cha.jpg'
    }
